...
public class Admin_refrigerator extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent I = new Intent( Admin_refrigerator .this, Home.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_profile:
//                    mTextMessage.setText(R.string.title_Profile);
                    I = new Intent( Admin_refrigerator.this,Profile.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_Booking:
//                    mTextMessage.setText(R.string.title_MyBooking);
                    I = new Intent( Admin_refrigerator.this, Booking.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_Help:
//                    mTextMessage.setText(R.string.title_HelpCenter);
                    Intent intent = new Intent( Admin_refrigerator.this, Help.class);
                    startActivity(intent);
                    return true;
                case R.id.navigation_logout:
//                    mTextMessage.setText(R.string.title_Logout);
                    intent = new Intent( Admin_refrigerator.this, Profile.class);
                    startActivity(intent);
                    finish();
                    return true;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_refrigerator);
        ...
        cardrefri_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent I = new Intent(Admin_refrigerator.this, RefrigerSingleOrder.class);
                startActivity(I);
