...
public class Microwave_Order extends AppCompatActivity {
    RadioGroup group;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_microwave__order);
        ...
        builder= new AlertDialog.Builder(Microwave_Order.this);
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Microwave_Order.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(Microwave_Order.this).addTorequestque(stringRequest);
            }
        });
        loadPrice();
    }
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(Microwave_Order.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(Microwave_Order.this,btn_2.getText(),Toast.LENGTH_LONG).show();
