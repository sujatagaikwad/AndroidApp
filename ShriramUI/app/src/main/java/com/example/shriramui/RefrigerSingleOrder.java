...
public class RefrigerSingleOrder extends AppCompatActivity {
    RadioGroup group;
    ...
    String url = "https://timely-oxides.000webhostapp.com/RefrigeratormachineSingle.php";
    AlertDialog.Builder builder;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_refriger_single_order);
        ...
        builder= new AlertDialog.Builder(RefrigerSingleOrder.this);
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                            ...
                            public void onResponse(String response) {
                                ...
                                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        edt_1.setText("");
                                        edt_3.setText("Refrigerator Machine Single_Type");
                                        editText_1.setText("");
                                        editText_2.setText("");
                                        editText_3.setText("");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(RefrigerSingleOrder.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(RefrigerSingleOrder.this).addTorequestque(stringRequest);
            }
        });
        loadPrice();
    }
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(RefrigerSingleOrder.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(RefrigerSingleOrder.this,btn_2.getText(),Toast.LENGTH_LONG).show();
