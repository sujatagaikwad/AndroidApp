...
public class RefrigerSide_By_Side extends AppCompatActivity {
    RadioGroup group;
    ...
    String url = "https://timely-oxides.000webhostapp.com/RefrigeratormachineSidebyside.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_refriger_side__by__side);
        ...
        builder= new AlertDialog.Builder(RefrigerSide_By_Side.this);
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                            ...
                            public void onResponse(String response) {
                                ...
                                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        edt_1.setText("");
                                        edt_3.setText("Refrigerator Side By Side Door");
                                        editText_1.setText("");
                                        editText_2.setText("");
                                        editText_3.setText("");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(RefrigerSide_By_Side.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(RefrigerSide_By_Side.this).addTorequestque(stringRequest);
            }
        });
        loadPrice();
    }
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(RefrigerSide_By_Side.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(RefrigerSide_By_Side.this,btn_2.getText(),Toast.LENGTH_LONG).show();
