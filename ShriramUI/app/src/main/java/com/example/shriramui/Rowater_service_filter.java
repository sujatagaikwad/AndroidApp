...
public class Rowater_service_filter extends AppCompatActivity {
    RadioGroup group;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rowater_service_filter);
        edt_2 =(TextView)findViewById(R.id.reapirp);
        ...
        builder= new AlertDialog.Builder(Rowater_service_filter.this);
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Rowater_service_filter.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(Rowater_service_filter.this).addTorequestque(stringRequest);
            }
        });
        loadPrice();
    }
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(Rowater_service_filter.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(Rowater_service_filter.this,btn_2.getText(),Toast.LENGTH_LONG).show();
