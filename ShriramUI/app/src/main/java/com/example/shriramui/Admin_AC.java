...
//                    mTextMessage.setText(R.string.title_Profile);
                    Intent I = new Intent( Admin_AC.this, Profile.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_Booking:
//                    mTextMessage.setText(R.string.title_MyBooking);
                    I = new Intent( Admin_AC.this, Booking.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_Help:
//                    mTextMessage.setText(R.string.title_HelpCenter);
                    Intent intent = new Intent( Admin_AC.this, Help.class);
                    startActivity(intent);
                    return true;
                case R.id.navigation_logout:
//                    mTextMessage.setText(R.string.title_Logout);
                    intent = new Intent( Admin_AC.this, Profile.class);
                    startActivity(intent);
                    finish();
                    return true;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__ac);
       ...
       card_3=(androidx.cardview.widget.CardView)findViewById(R.id.cardviewinstall);
        card_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent I = new Intent(Admin_AC.this,WindowAcRepair_order.class);
                startActivity(I);
            }
        });
        card_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent I = new Intent(Admin_AC.this,WindowAc_Cleaning_order.class);
                startActivity(I);
            }
        });
        card_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent I = new Intent(Admin_AC.this,Ac_install_Uninstall.class);
                startActivity(I);
            }
        });
        loadPrice();
