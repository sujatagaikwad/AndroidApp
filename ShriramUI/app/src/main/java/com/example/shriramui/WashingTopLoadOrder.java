...
public class WashingTopLoadOrder extends AppCompatActivity {
    RadioGroup group;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_washing_top_load_order);
       ...
       // edt_2=(TextView)findViewById(R.id.installp) ;
        ...
        builder= new AlertDialog.Builder(WashingTopLoadOrder.this);
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                            ...
                            public void onResponse(String response) {
                                ...
                                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        edt_1.setText("");
                                       // edt_2.setText("");
                                        edt_3.setText("Washing Machine TopLoad repire");
                                        editText_1.setText("");
                                        editText_2.setText("");
                                        editText_3.setText("");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(WashingTopLoadOrder.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(WashingTopLoadOrder.this).addTorequestque(stringRequest);
            }
        });
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(WashingTopLoadOrder.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(WashingTopLoadOrder.this,btn_2.getText(),Toast.LENGTH_LONG).show();
