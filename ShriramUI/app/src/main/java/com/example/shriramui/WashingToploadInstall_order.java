...
public class WashingToploadInstall_order extends AppCompatActivity {
    RadioGroup group;
    RadioButton btn_1,btn_2;
    Button btn_3;
    TextView edt_1,edt_2,edt_3;
    EditText editText_1,editText_2,editText_3;
    String url = "https://timely-oxides.000webhostapp.com/WashingmachineFrontLoad.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_washing_topload_install_order);
       // edt_1=(TextView)findViewById(R.id.reapirp) ;
        edt_2=(TextView)findViewById(R.id.installp) ;
        ...
        builder= new AlertDialog.Builder(WashingToploadInstall_order.this);
               ...
               // Repairprice=edt_1.getText().toString();
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                            ...
                            public void onResponse(String response) {
                                ...
                                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                      //  edt_1.setText("");
                                       edt_2.setText("");
                                        edt_3.setText("Washing Machine TopLoad_install/uninsstall");
                                        editText_1.setText("");
                                        editText_2.setText("");
                                        editText_3.setText("");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(WashingToploadInstall_order.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(WashingToploadInstall_order.this).addTorequestque(stringRequest);
            }
        });
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(WashingToploadInstall_order.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(WashingToploadInstall_order.this,btn_2.getText(),Toast.LENGTH_LONG).show();
