...
public class WashingTopload extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent I = new Intent( WashingTopload.this, Home.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_profile:
//                    mTextMessage.setText(R.string.title_Profile);
                    I = new Intent( WashingTopload.this, Profile.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_Booking:
//                    mTextMessage.setText(R.string.title_MyBooking);
                    I = new Intent( WashingTopload.this, Booking.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_Help:
//                    mTextMessage.setText(R.string.title_HelpCenter);
                    Intent intent = new Intent( WashingTopload.this, Help.class);
                    startActivity(intent);
                    return true;
                case R.id.navigation_logout:
//                    mTextMessage.setText(R.string.title_Logout);
                    intent = new Intent( WashingTopload.this, Profile.class);
                    startActivity(intent);
                    finish();
                    return true;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_washing_topload);
...
//        displayPrice();
        cardmicroview_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent I = new Intent(WashingTopload.this, WashingTopLoadOrder.class);
                startActivity(I);
            }
        });
        cardmicroview_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent I = new Intent(WashingTopload.this, WashingToploadInstall_order.class);
                startActivity(I);
