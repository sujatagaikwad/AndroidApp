...
public class Split_Ac_cleaning_order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_split__ac_cleaning_order);
        ...
        builder= new AlertDialog.Builder(Split_Ac_cleaning_order.this);
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                            ...
                            public void onResponse(String response) {
                                ...
                                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        edt_1.setText("");
                                        edt_3.setText("AC Split Ac Cleaning");
                                        editText_1.setText("");
                                        editText_2.setText("");
                                        editText_3.setText("");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Split_Ac_cleaning_order.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(Split_Ac_cleaning_order.this).addTorequestque(stringRequest);
            }
        });
        loadPrice();
    }
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(Split_Ac_cleaning_order.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(Split_Ac_cleaning_order.this,btn_2.getText(),Toast.LENGTH_LONG).show();
