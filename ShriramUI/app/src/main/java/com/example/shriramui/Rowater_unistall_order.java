...
public class Rowater_unistall_order extends AppCompatActivity {
    RadioGroup group;
    RadioButton btn_1,btn_2;
    Button btn_3;
    TextView edt_1,edt_2,edt_3,txt_2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rowater_unistall_order);
        txt_2=(TextView)findViewById(R.id.reapirp);
               ...
               // Repairprice=txt_2.getText().toString();
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                            ...
                            public void onResponse(String response) {
                                ...
                                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                       // txt_1.setText("");
                                        txt_2.setText("");
                                        edt_3.setText("Rowater UnInstall order");
                                        editText_1.setText("");
                                        editText_2.setText("");
                                        editText_3.setText("");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Rowater_unistall_order.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(Rowater_unistall_order.this).addTorequestque(stringRequest);
            }
        });
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(Rowater_unistall_order.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(Rowater_unistall_order.this,btn_2.getText(),Toast.LENGTH_LONG).show();
