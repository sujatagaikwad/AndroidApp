...
public class WindowAc_Cleaning_order extends AppCompatActivity {
    String url = "https://timely-oxides.000webhostapp.com/AcwindowAcprice.php";
    RadioGroup group;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_window_ac__cleaning_order);
        ...
        builder= new AlertDialog.Builder(WindowAc_Cleaning_order.this);
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                            ...
                            public void onResponse(String response) {
                                ...
                                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        edt_1.setText("");
                                        edt_3.setText("AC Window Ac Cleaning");
                                        editText_1.setText("");
                                        editText_2.setText("");
                                        editText_3.setText("");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(WindowAc_Cleaning_order.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(WindowAc_Cleaning_order.this).addTorequestque(stringRequest);
            }
        });
        loadPrice();
    }
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(WindowAc_Cleaning_order.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(WindowAc_Cleaning_order.this,btn_2.getText(),Toast.LENGTH_LONG).show();
