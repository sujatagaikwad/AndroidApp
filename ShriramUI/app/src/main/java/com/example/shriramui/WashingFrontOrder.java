...
public class WashingFrontOrder extends AppCompatActivity {
    RadioGroup group;
   ...
   AlertDialog.Builder builder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_washing_front_order);
       ...
       builder= new AlertDialog.Builder(WashingFrontOrder.this);
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                            ...
                            public void onResponse(String response) {
                                ...
                                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        edt_1.setText("");
                                       // edt_2.setText("");
                                        edt_3.setText("Washing Machine FrontLoad");
                                        editText_1.setText("");
                                        editText_2.setText("");
                                        editText_3.setText("");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(WashingFrontOrder.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(WashingFrontOrder.this).addTorequestque(stringRequest);
            }
        });
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(WashingFrontOrder.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(WashingFrontOrder.this,btn_2.getText(),Toast.LENGTH_LONG).show();
