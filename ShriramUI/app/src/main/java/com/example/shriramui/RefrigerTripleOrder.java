...
public class RefrigerTripleOrder extends AppCompatActivity {
    RadioGroup group;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_refriger_triple_order);
        ...
        builder= new AlertDialog.Builder(RefrigerTripleOrder.this);
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                            ...
                            public void onResponse(String response) {
                                ...
                                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        edt_1.setText("");
                                        edt_3.setText("Refrigerator Machine Triple_Type");
                                        editText_1.setText("");
                                        editText_2.setText("");
                                        editText_3.setText("");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(RefrigerTripleOrder.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(RefrigerTripleOrder.this).addTorequestque(stringRequest);
            }
        });
        loadPrice();
    }
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(RefrigerTripleOrder.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(RefrigerTripleOrder.this,btn_2.getText(),Toast.LENGTH_LONG).show();
