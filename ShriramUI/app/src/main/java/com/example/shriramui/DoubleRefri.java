...
public class DoubleRefri extends AppCompatActivity {
    private ImageView img;
    TextView txt_1, txt_3, txt_4, edit_2;
    TextView edit_1, edit_3;
    CardView cardrefri_1,cardrefri_2;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent I = new Intent( DoubleRefri .this, Home.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_profile:
//                    mTextMessage.setText(R.string.title_Profile);
                    I = new Intent( DoubleRefri.this,Profile.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_Booking:
//                    mTextMessage.setText(R.string.title_MyBooking);
                    I = new Intent( DoubleRefri.this, Booking.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_Help:
//                    mTextMessage.setText(R.string.title_HelpCenter);
                    Intent intent = new Intent( DoubleRefri.this, Help.class);
                    startActivity(intent);
                    return true;
                case R.id.navigation_logout:
//                    mTextMessage.setText(R.string.title_Logout);
                    intent = new Intent( DoubleRefri.this, Profile.class);
                    startActivity(intent);
                    return true;
            }
            return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_double_refri);
        ...
        cardrefri_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent I = new Intent(DoubleRefri.this,RefrigerDoubleOrder.class);
                startActivity(I);
