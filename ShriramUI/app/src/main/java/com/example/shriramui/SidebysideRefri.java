...
public class SidebysideRefri extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent I = new Intent( SidebysideRefri .this, Home.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_profile:
//                    mTextMessage.setText(R.string.title_Profile);
                    I = new Intent( SidebysideRefri.this,Profile.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_Booking:
//                    mTextMessage.setText(R.string.title_MyBooking);
                    I = new Intent( SidebysideRefri.this, Booking.class);
                    startActivity(I);
                    return true;
                case R.id.navigation_Help:
//                    mTextMessage.setText(R.string.title_HelpCenter);
                    Intent intent = new Intent( SidebysideRefri.this, Help.class);
                    startActivity(intent);
                    return true;
                case R.id.navigation_logout:
//                    mTextMessage.setText(R.string.title_Logout);
                    intent = new Intent( SidebysideRefri.this, Profile.class);
                    startActivity(intent);
                    finish();
                    return true;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sidebyside_refri);
        ...
        cardrefri_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent I = new Intent(SidebysideRefri.this, RefrigerSide_By_Side.class);
                startActivity(I);
