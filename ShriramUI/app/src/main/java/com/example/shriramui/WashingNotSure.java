...
public class WashingNotSure extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_washing_not_sure);
       edt_1=(TextView)findViewById(R.id.repaire) ;
       //edt_2=(TextView)findViewById(R.id.installp) ;
        ...
        builder= new AlertDialog.Builder(WashingNotSure.this);
               ...
               // InstallPrice=edt_2.getText().toString();
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                            ...
                            public void onResponse(String response) {
                                ...
                                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                       edt_1.setText("");
                                       //edt_2.setText("");
                                        edt_3.setText("Washing Machine Not Sure");
                                        editText_1.setText("");
                                        editText_2.setText("");
                                        editText_3.setText("");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(WashingNotSure.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(WashingNotSure.this).addTorequestque(stringRequest);
            }
        });
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(WashingNotSure.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(WashingNotSure.this,btn_2.getText(),Toast.LENGTH_LONG).show();
