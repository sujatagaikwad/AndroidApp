...
public class Ac_install_Uninstall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ac_install__uninstall);
        ...
        builder= new AlertDialog.Builder(Ac_install_Uninstall.this);
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                            ...
                            public void onResponse(String response) {
                                ...
                                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        edt_1.setText("");
                                        edt_3.setText("AC Window Ac Installing/Uninstalling");
                                        editText_1.setText("");
                                        editText_2.setText("");
                                        editText_3.setText("");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Ac_install_Uninstall.this,"Error.....",Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(Ac_install_Uninstall.this).addTorequestque(stringRequest);
            }
        });
    ...
    public void radiomr(View view){
        ...
        Toast.makeText(Ac_install_Uninstall.this,btn_1.getText(),Toast.LENGTH_LONG).show();
    }
    public void radiomiss(View view){
        ...
        Toast.makeText(Ac_install_Uninstall.this,btn_2.getText(),Toast.LENGTH_LONG).show();
